<div class="table-responsive" style="position: relative; overflow:visible">
            ...
            <tr class="table-row">
                ...
                <td class="hotel-cell">
                    <div class="hotel-info">
                        ...
                        <span class="badge badge-sm <?= $transportacion['isIncluida'] == "1" ? 'badge-success' : 'badge-warning' ?>"><?= $transportacion['isIncluida'] == "1" ? "Incluida" : "Con costo" ?></span>
                    </div>
                </td>
                ...
                <td class="status-cell">
                    <div class="dropdown text-center">
                        <button class="btn btn-sm <?= $styleMap[$transportacion['hotel'].'-'.$transportacion['status']] ?? 'btn-secondary' ?> dropdown-toggle status-btn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <button id="exportXls" class="btn btn-success mr-2" title="Exportar a Excel">
